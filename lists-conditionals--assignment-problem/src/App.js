...
class App extends Component {
  ...
  render() {
    const chars = this.state.text.split('').map((c, idx) => {
      return <CharComponent
        char={c}
        click={() => this.removeCharHandler(idx)}/>
    });

    return (
      <div className="App blockDiv">
        <ol>
        ...
        <div className='blockDiv'>
          <input onChange={this.textInputHandler} value={this.state.text}></input>
          <p>{this.state.text}</p>
